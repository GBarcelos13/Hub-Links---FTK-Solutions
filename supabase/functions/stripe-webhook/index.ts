...
// Secret needed: STRIPE_WEBHOOK_SECRET (besides STRIPE_SECRET_KEY + SERVICE_ROLE)
  ...
  await admin.from('subscriptions').upsert(
    {
      ...
      plan,
      status: sub.status as PlanTier extends never ? never : Stripe.Subscription.Status,
