...
export function Header() {
  ...
  return (
    <header className="w-full border-b-2 border-header-border bg-header-bg sticky top-0 z-50 shadow-md">
        ...
        <div className="flex items-center gap-4">
          {isAdmin && (
            <Button
              ...
              className="gap-2 text-header-fg hover:bg-white/10 hover:text-header-fg"
            >
